...
class PaymentConfigController extends Controller
{
    ...
    public function payment_config_set(Request $request): RedirectResponse
    {
        ...
        } elseif ($request['gateway'] == 'pagarme') {
            $additional_data = [
                'status' => 'required|in:1,0',
                'secret_key' => 'required',
                'public_key' => 'nullable',
