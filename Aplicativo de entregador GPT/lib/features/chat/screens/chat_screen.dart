...
class ChatScreen extends StatefulWidget {
  ...
  const ChatScreen({super.key, required this.notificationBody, required this.user, this.conversationId, this.fromNotification = false, this.fromSupport, this.initialMessage});
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void initState() {
    ...
    final String supportInitialMessage = widget.initialMessage?.trim() ?? '';
    if(supportInitialMessage.isNotEmpty) {
      _inputMessageController.text = supportInitialMessage;
