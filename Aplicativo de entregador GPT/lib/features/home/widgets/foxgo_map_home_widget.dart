  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: Stack(children: [
        ...
        const Center(
          child: IgnorePointer(
            child: Icon(Icons.navigation_rounded, color: Color(0xFF1976D2), size: 44),
          ),
        ),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Row(children: [
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text('foxgo_home_earnings_panel'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
