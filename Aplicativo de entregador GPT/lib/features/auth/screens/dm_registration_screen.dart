...
class _DmRegistrationScreenState extends State<DmRegistrationScreen> {
  ...
  static const Map<String, String> _vehicleTypePtBrLabels = {
    'bike_delivery': 'Bicicleta — Entrega',
    'moto_delivery': 'Moto — Entrega',
    'car_delivery': 'Carro — Entrega',
    'utility_delivery': 'Utilitário — Entrega',
    'van_delivery': 'Van — Entrega',
    'moto_ride': 'Moto — Corrida',
    'car_economy_ride': 'Carro econômico — Corrida',
    'car_comfort_ride': 'Carro conforto — Corrida',
    'car_executive_ride': 'Carro executivo — Corrida',
    'van_ride': 'Van — Corrida',
    'electric_bike_delivery': 'Bicicleta elétrica — Entrega',
    'taxi_ride': 'Táxi — Corrida',
  };

  String _vehicleTypeDisplayName(String? rawType) {
    if (rawType == null || rawType.isEmpty) {
      return '';
    }
    return _vehicleTypePtBrLabels[rawType] ?? rawType;
  }
                          ...
                          isRideActive ? SizedBox() : authController.vehicleIds != null ? Stack(clipBehavior: Clip.none, children: [
                            CustomDropdownButton(
                              ...
                              dropdownMenuItems: authController.vehicles!.map((vehicle) => DropdownMenuItem<String>(
                                ...
                                child: Text(_vehicleTypeDisplayName(vehicle.type), style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeDefault)),
                              )).toList(),
