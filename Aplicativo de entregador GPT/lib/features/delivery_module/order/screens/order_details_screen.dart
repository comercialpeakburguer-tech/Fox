...
import 'package:sixam_mart_delivery/features/delivery_module/order/widgets/foxgo_delivery_support_widget.dart';
        ...
        body: SafeArea(
          child: GetBuilder<OrderController>(builder: (orderController) {
            ...
            return (orderController.orderDetailsModel != null && controllerOrderModel != null) ? Column(children: [
              ...
              FoxGoCustomerNoShowTimerWidget(
                order: controllerOrderModel,
                parcel: parcel,
              ),
              const SizedBox(height: Dimensions.paddingSizeDefault),
              FoxGoDeliverySupportWidget(order: controllerOrderModel, parcel: parcel),
