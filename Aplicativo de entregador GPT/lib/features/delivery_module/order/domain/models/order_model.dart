...
class OrderModel {
  ...
  // Fox GO Logistics/App: dados da offer/chamada ativa enviados pelo latest-orders.
  int? foxgoOfferId;
  String? foxgoOfferUuid;
  String? foxgoOfferStatus;
  String? foxgoOfferExpiresAt;
  int? foxgoOfferRemainingSeconds;
  int? foxgoOfferTtlSeconds;
  double? foxgoDriverEarningAmount;
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    ...
    scheduled = json['scheduled'] == 1 ? true : false;
    ...
    foxgoOfferId = int.tryParse(json['foxgo_offer_id']?.toString() ?? '');
    foxgoOfferUuid = json['foxgo_offer_uuid']?.toString();
    foxgoOfferStatus = json['foxgo_offer_status']?.toString();
    foxgoOfferExpiresAt = json['foxgo_offer_expires_at']?.toString();
    foxgoOfferRemainingSeconds = int.tryParse(json['foxgo_offer_remaining_seconds']?.toString() ?? '');
    foxgoOfferTtlSeconds = int.tryParse(json['foxgo_offer_ttl_seconds']?.toString() ?? '');
    foxgoDriverEarningAmount = json['foxgo_driver_earning_amount'] == null
        ? null
        : double.tryParse(json['foxgo_driver_earning_amount'].toString());
  ...
  Map<String, dynamic> toJson() {
    ...
    data['foxgo_offer_id'] = foxgoOfferId;
    data['foxgo_offer_uuid'] = foxgoOfferUuid;
    data['foxgo_offer_status'] = foxgoOfferStatus;
    data['foxgo_offer_expires_at'] = foxgoOfferExpiresAt;
    data['foxgo_offer_remaining_seconds'] = foxgoOfferRemainingSeconds;
    data['foxgo_offer_ttl_seconds'] = foxgoOfferTtlSeconds;
    data['foxgo_driver_earning_amount'] = foxgoDriverEarningAmount;
    return data;
  }
}
...
class ParcelCancellation {
  ...
  ParcelCancellation.fromJson(Map<String, dynamic> json) {
    ...
    setReturnDate = json['set_return_date'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['set_return_date'] = setReturnDate;
    return data;
  }
}