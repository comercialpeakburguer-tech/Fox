...
class _VerifyDeliverySheetWidgetState extends State<VerifyDeliverySheetWidget> {
  ...
  bool get _isPickupOtp => widget.currentOrderModel.orderStatus == 'handover';

  String get _titleText => _isPickupOtp ? 'foxgo_pickup_code_label'.tr : 'otp_verification'.tr;

  String get _descriptionText => _isPickupOtp
      ? 'foxgo_pickup_code_sheet_description'.tr
      : 'enter_otp_number'.tr;

  String get _helperText => _isPickupOtp
      ? 'foxgo_pickup_code_sheet_helper'.tr
      : 'collect_otp_from_customer'.tr;

  String get _buttonText => _isPickupOtp
      ? 'foxgo_pickup_confirm_button'.tr
      : (widget.verify! ? 'submit'.tr : 'ok'.tr);

  String get _incompleteOtpText => _isPickupOtp
      ? 'foxgo_pickup_incomplete_code'.tr
      : 'enter_otp_number'.tr;
        ...
        return Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            widget.verify! ? Column(children: [
              ...
              Text(_titleText, style: robotoBold, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),

              Text(_descriptionText, style: robotoRegular.copyWith(color: Theme.of(context).disabledColor), textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              ...
              Text(_helperText, style: robotoRegular, textAlign: TextAlign.center),
              const SizedBox(height: Dimensions.paddingSizeLarge),
