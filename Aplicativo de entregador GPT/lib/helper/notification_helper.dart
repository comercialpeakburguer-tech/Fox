    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) async {
      ...
      if(type == 'new_order' || type == 'order_request') {
        ...
        if(isOnline) {
          ...
          final overlayPayload = Get.find<OrderController>().foxgoOverlayPayloadForOrder(orderId, {
            ...
            'foxgo_offer_id': message.data['foxgo_offer_id']?.toString(),
            'foxgo_offer_uuid': message.data['foxgo_offer_uuid']?.toString(),
            'foxgo_offer_status': message.data['foxgo_offer_status']?.toString(),
            'foxgo_offer_expires_at': message.data['foxgo_offer_expires_at']?.toString(),
            'foxgo_offer_remaining_seconds': message.data['foxgo_offer_remaining_seconds']?.toString(),
            'foxgo_offer_ttl_seconds': message.data['foxgo_offer_ttl_seconds']?.toString(),
            'foxgo_driver_earning_amount': message.data['foxgo_driver_earning_amount']?.toString(),
          });
          try {
...
Map<String, dynamic> _buildOverlayPayloadFromMessage(Map<String, dynamic> data) {
  ...
  return {
    ...
    'isRide': data['is_ride']?.toString() == '1' || rawType.toLowerCase().contains('ride'),
      'foxgo_offer_id': data['foxgo_offer_id']?.toString(),
      'foxgo_offer_uuid': data['foxgo_offer_uuid']?.toString(),
      'foxgo_offer_status': data['foxgo_offer_status']?.toString(),
      'foxgo_offer_expires_at': data['foxgo_offer_expires_at']?.toString(),
      'foxgo_offer_remaining_seconds': data['foxgo_offer_remaining_seconds']?.toString(),
      'foxgo_offer_ttl_seconds': data['foxgo_offer_ttl_seconds']?.toString(),
      'foxgo_driver_earning_amount': data['foxgo_driver_earning_amount']?.toString(),
  };
}
