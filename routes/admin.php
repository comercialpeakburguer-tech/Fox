...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin', 'current-module', 'actch:admin_panel']], function () {
        ...
        // Fox GO - Central de Suporte separada do painel completo
        Route::group(['prefix' => 'support', 'as' => 'support.'], function () {
            Route::get('/', 'FoxGoSupportController@index')->name('index');
            Route::get('team', 'FoxGoSupportController@team')->name('team');
            Route::post('team/assign', 'FoxGoSupportController@teamAssign')->name('team.assign');
            Route::post('team/toggle/{id}', 'FoxGoSupportController@teamToggle')->name('team.toggle');
            Route::get('cases', 'FoxGoSupportController@cases')->name('cases');
            Route::get('cases/create', 'FoxGoSupportController@create')->name('cases.create');
            Route::post('cases/store', 'FoxGoSupportController@store')->name('cases.store');
            Route::get('cases/{caseId}', 'FoxGoSupportController@show')->name('cases.show');
            Route::post('cases/{caseId}/transfer', 'FoxGoSupportController@transfer')->name('cases.transfer');
            Route::post('cases/{caseId}/evidence', 'FoxGoSupportController@evidence')->name('cases.evidence');
            Route::post('cases/{caseId}/status', 'FoxGoSupportController@statusUpdate')->name('cases.status');
            Route::post('cases/{caseId}/internal-note', 'FoxGoSupportController@internalNote')->name('cases.internal-note');
            Route::post('cases/{caseId}/conversation/customer', 'FoxGoSupportController@linkCustomerConversation')->name('cases.conversation.customer');
            Route::post('cases/{caseId}/nina/guidance', 'FoxGoSupportController@ninaGuidance')->name('cases.nina.guidance');
        Route::post('cases/{caseId}/nina/send-customer', [\App\Http\Controllers\Admin\FoxGoSupportController::class, 'sendNinaCustomerMessage'])->name('cases.nina.send-customer');
        });
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
            ...
            Route::group(['middleware' => ['module:store']], function () {
                ...
                Route::get('foxgo-stripe-verification/{store}', 'VendorController@foxgoStripeVerification')->name('foxgo-stripe-verification');
                Route::post('foxgo-stripe-verification/{store}', 'VendorController@foxgoStripeVerificationSubmit')->name('foxgo-stripe-verification-submit');
                Route::post('foxgo-stripe-verification-refresh/{store}', 'VendorController@foxgoStripeVerificationRefresh')->name('foxgo-stripe-verification-refresh');
