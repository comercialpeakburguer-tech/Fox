...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor', 'actch:admin_panel']], function () {
        ...
        Route::group(['prefix' => 'meu-catalogo', 'as' => 'foxgo-catalog.', 'middleware' => ['module:item','subscription:item']], function () {
            Route::get('/', 'FoxGoStoreCatalogController@index')->name('index');

            Route::post('categoria/store', 'FoxGoStoreCatalogController@storeCategory')->name('category.store');
            Route::post('categoria/update/{id}', 'FoxGoStoreCatalogController@updateCategory')->name('category.update');
            Route::get('categoria/status/{id}/{status}', 'FoxGoStoreCatalogController@statusCategory')->name('category.status');
            Route::delete('categoria/delete/{id}', 'FoxGoStoreCatalogController@deleteCategory')->name('category.delete');

            Route::post('marca/store', 'FoxGoStoreCatalogController@storeBrand')->name('brand.store');
