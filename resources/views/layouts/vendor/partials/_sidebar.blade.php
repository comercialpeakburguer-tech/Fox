                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @endif
                      @if (
                          \App\CentralLogics\Helpers::employee_module_permission_check('item') ||
                              \App\CentralLogics\Helpers::employee_module_permission_check('addon'))
                          <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor-panel/meu-catalogo*') || Request::is('vendor-panel/item*') || Request::is('vendor-panel/addon*') ? 'active' : '' }}">
                              <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                  title="Meu Catálogo">
                                  <i class="tio-folder-bookmarked nav-icon"></i>
                                  <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">Meu Catálogo</span>
                              </a>

                              <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                  style="display: {{ Request::is('vendor-panel/meu-catalogo*') || Request::is('vendor-panel/item*') || Request::is('vendor-panel/addon*') ? 'block' : 'none' }}">

                                  @if (\App\CentralLogics\Helpers::employee_module_permission_check('item'))
                                      <li class="nav-item {{ Request::is('vendor-panel/meu-catalogo*') ? 'active' : '' }}">
                                          <a class="nav-link" href="{{ route('vendor.foxgo-catalog.index') }}" title="Estrutura do catálogo">
                                              <span class="tio-circle nav-indicator-icon"></span>
                                              <span class="text-truncate">Estrutura do catálogo</span>
                                          </a>
                                      </li>

                                      <li class="nav-item {{ Request::is('vendor-panel/item/add-new') ? 'active' : '' }}">
                                          <a class="nav-link" href="{{ route('vendor.item.add-new') }}" title="{{ translate('messages.add_new_item') }}">
                                              <span class="tio-circle nav-indicator-icon"></span>
                                              <span class="text-truncate">Novo produto</span>
                                          </a>
                                      </li>

                                      <li class="nav-item {{ Request::is('vendor-panel/item/list') ? 'active' : '' }}">
                                          <a class="nav-link" href="{{ route('vendor.item.list') }}" title="{{ translate('messages.items_list') }}">
                                              <span class="tio-circle nav-indicator-icon"></span>
                                              <span class="text-truncate">Lista de produtos</span>
                                          </a>
                                      </li>
                                      ...
                                      @if (\App\CentralLogics\Helpers::get_mail_status('product_approval'))
                                          <li class="nav-item {{ Request::is('vendor-panel/item/pending/item/list') || Request::is('vendor-panel/item/requested/item/view/*') ? 'active' : '' }}">
                                              <a class="nav-link" href="{{ route('vendor.item.pending_item_list') }}" title="{{ translate('messages.pending_item_list') }}">
                                                  <span class="tio-circle nav-indicator-icon"></span>
                                      ...
                                      @if (\App\CentralLogics\Helpers::get_store_data()->item_section)
                                          <li class="nav-item {{ Request::is('vendor-panel/item/bulk-import') ? 'active' : '' }}">
                                              <a class="nav-link" href="{{ route('vendor.item.bulk-import') }}" title="{{ translate('messages.bulk_import') }}">
                                                  <span class="tio-circle nav-indicator-icon"></span>
                                          ...
                                          <li class="nav-item {{ Request::is('vendor-panel/item/bulk-export') ? 'active' : '' }}">
                                              <a class="nav-link" href="{{ route('vendor.item.bulk-export-index') }}" title="{{ translate('messages.bulk_export') }}">
                                                  <span class="tio-circle nav-indicator-icon"></span>
                                  ...
                                  @if (\App\CentralLogics\Helpers::employee_module_permission_check('addon'))
                                      <li class="nav-item {{ Request::is('vendor-panel/addon*') ? 'active' : '' }}">
                                          <a class="nav-link" href="{{ route('vendor.addon.add-new') }}" title="{{ translate('messages.addons') }}">
                                              <span class="tio-circle nav-indicator-icon"></span>
                                              <span class="text-truncate">{{ translate('messages.addons') }}</span>
                                          </a>
                                      </li>
                                  @endif
                              </ul>
