            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    @if (\App\CentralLogics\Helpers::module_permission_check('settings'))
                        ...
                        {{-- Fox GO - Central de Suporte --}}
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/support*') ? 'active' : '' }}">
                            <a class="nav-link"
                               href="{{ route('admin.support.index') }}"
                               title="Central de Suporte">
                                <span class="tio-message nav-icon"></span>
                                <span class="text-truncate">Central de Suporte</span>
                            </a>
                        </li>
                        {{-- Fox GO - Central de Suporte End --}}
                        <li
