...
{{-- Fox GO Brasil: checkbox Halal removido da interface. --}}
...
@if (Config::get('module.current_module_type') == 'food')
    <div class="col-lg-12" id="foxgo_food_settings_block">
        <div class="general_wrapper">
            <div class="outline-wrapper">
                <div class="card shadow--card-2 border-0 bg-animate">
                    <div class="card-header">
                        <h5 class="card-title">
                            <span class="card-header-icon mr-2"><i class="tio-settings"></i></span>
                        ...
                        <div class="row g-3 align-items-start">
                            @if (Auth::guard('admin')->check())
                                <div class="col-lg-6" id="addon_input">
                                    <div class="form-group mb-0 error-wrapper">
                                        <label class="input-label" for="add_on">
                                            {{ translate('Select_Add-on') }}
                                            <span class="input-label-secondary" data-toggle="tooltip" data-placement="right"
                                                data-original-title="{{ translate('messages.The_selected_addon’s_will_be_displayed_in_this_food_details') }}">
                                                <img src="{{ asset('/public/assets/admin/img/info-circle.svg') }}"
                                                    alt="{{ translate('messages.The_selected_addon’s_will_be_displayed_in_this_food_details') }}">
                                            </span>
                                        </label>
                                        ...
                                        <small class="text-muted d-block mt-1">
                                            Selecione os complementos disponíveis para este produto.
                                        </small>
                                    </div>
                                </div>
                            @else
                            ...
                            <div class="col-lg-6" id="time_input">
                                ...
                                <div class="row g-2">
                                    <div class="col-sm-6">
                                        <div class="form-group mb-0 error-wrapper">
                                            <label class="input-label"
                                                for="available_time_starts">{{ translate('messages.available_time_starts') }}<span
                                                    class="form-label-secondary text-danger" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('messages.Required.') }}">
                                                    *
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group mb-0 error-wrapper">
                                            <label class="input-label"
                                                for="available_time_ends">{{ translate('messages.available_time_ends') }}<span
                                                    class="form-label-secondary text-danger" data-toggle="tooltip"
                                                    data-placement="right"
                                                    data-original-title="{{ translate('messages.Required.') }}">
                                                    *
                                            ...
                                            <input type="time" name="available_time_ends" class="form-control"
                                                ...
                                                id="available_time_ends" placeholder="00:00" required>
                                        </div>
                                    </div>
                                </div>
                                <small class="text-muted d-block mt-1">
                                    Defina o horário em que este produto ficará disponível para venda.
                                </small>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group mb-0 error-wrapper">
                                    ...
                                    <small class="text-muted d-block mt-1">
                                        Use palavras que ajudem o cliente a encontrar o produto, como hambúrguer, combo, artesanal ou batata.
                                    </small>
                                </div>
                            </div>
                        </div>
