            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tr>
                        ...
                        <th class="text-uppercase border-0">Repasses</th>
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    ...
                                    $foxgoRepassesLabel = 'Pendente';
                                    $foxgoRepassesClass = 'badge-soft-warning';

                                    if ($foxgoRepassesActive) {
                                        $foxgoRepassesLabel = 'Ativo';
                                        $foxgoRepassesClass = 'badge-soft-success';
                                    } elseif (!$foxgoHasStripeAccount) {
                                        $foxgoRepassesLabel = 'Sem conta';
                                        $foxgoRepassesClass = 'badge-soft-secondary';
                                    } elseif (!empty($foxgoDisabledReason)) {
                                        $foxgoRepassesLabel = 'Bloqueado';
                                        $foxgoRepassesClass = 'badge-soft-danger';
                                    }
                                @endphp
                                <span class="badge {{ $foxgoRepassesClass }}">Repasses: {{ $foxgoRepassesLabel }}</span>
                            </td>
                            <td>
