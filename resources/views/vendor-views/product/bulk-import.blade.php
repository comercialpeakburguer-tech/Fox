            ...
            <div class="card mt-2 rest-part">
                <div class="card-body">
                    ...
                    <div class="custom-file custom--file">
                        <input type="file" name="products_file" class="custom-file-input" id="products_file" accept=".xlsx,.xls">
                        <label class="custom-file-label" for="products_file">{{ translate('messages.Choose File') }}</label>
                    </div>
                    <small class="text-muted d-block mt-2">
                        Use somente a planilha modelo baixada acima, nos formatos .xlsx ou .xls.
                    </small>
                    ...
                    <div class="card-header d-flex flex-wrap align-items-center justify-content-between gap-2">
                        <div>
                            <h5 class="card-title mb-1">
                                <span class="card-header-icon mr-2"><i class="tio-canvas-text"></i></span>
                                <span>{{ translate('messages.food_variations_generator') }}</span>
                            </h5>
                            <small class="text-muted">
                                Ferramenta opcional para montar variações e copiar o resultado para a coluna correta da planilha.
                            </small>
                        </div>
                        <button class="btn btn--primary btn-outline-primary" type="button" data-toggle="collapse"
                            data-target="#foodVariationGeneratorBox" aria-expanded="false" aria-controls="foodVariationGeneratorBox">
                            Abrir gerador
                        </button>
                    </div>
                    <div class="collapse" id="foodVariationGeneratorBox">
                    <div class="card-body">
                        <div class="row g-2">
                            <div class="col-md-12">
                        ...
                        <label class="input-label">Resultado para copiar na planilha</label>
                        <textarea name="" id="food_variation_outpot" class="form-control" rows="3" readonly
                            placeholder="Depois de gerar, copie este valor para a coluna de variações da planilha."></textarea>
                    </div>
                    </div>
                </div>
            </div>
