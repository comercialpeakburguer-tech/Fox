...
class _StoreScreenState extends State<StoreScreen> {
  ...
  Future<void> initDataCall() async {
    ...
    await Get.find<StoreController>().getStoreDetails(Store(id: widget.store!.id), widget.fromModule, slug: '').then((value) {
                                  ...
                                  children: [
                                    Expanded(
                                      child: ListView.builder(
                                        ...
                                        itemCount: storeController.categoryList!.length > 1 ? storeController.categoryList!.length : 0,
