    ...
    return Column(children: [
      ResponsiveHelper.isDesktop(context) ? Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          store!.minimumOrder != null && store!.minimumOrder! > 0.0 ? Row(children: [
            Text('${'minimum_order_amount_is'.tr}:', style: robotoRegular.copyWith(
       ...
       child: Row(children: [
         ...
         InkWell(
           ...
           child: Column(children: [
             ...
             Text(
               '${store!.ratingCount} ${store!.ratingCount! < 1 ? '' : '+'} ${store!.ratingCount! < 1 ? 'rating'.tr : 'ratings'.tr}',
