            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  _config!.downloadUserAppLinks!.playStoreUrlStatus == '1' ? InkWell(
                    onTap: () => _launchURL(_config.downloadUserAppLinks!.playStoreUrl ?? ''),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
                      child: Image.asset(Images.landingGooglePlay, height: 40, fit: BoxFit.contain),
                    ),
                  ) : const SizedBox(),
                  SizedBox(width: _config.downloadUserAppLinks!.playStoreUrlStatus == '1' ? Dimensions.paddingSizeSmall : 0.0),

                  _config.downloadUserAppLinks!.appleStoreUrlStatus == '1' ? InkWell(
                    onTap: () => _launchURL(_config.downloadUserAppLinks!.appleStoreUrl ?? ''),
                    child: Padding(
                      padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeExtraSmall),
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment : MainAxisAlignment.spaceBetween, children: [
                          ...
                          FooterButton(title: 'privacy_policy'.tr, route: RouteHelper.privacyPolicy),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          FooterButton(title: 'terms_and_condition'.tr, route: RouteHelper.termsAndCondition),
