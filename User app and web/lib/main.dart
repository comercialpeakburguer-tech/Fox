...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb){
    await Firebase.initializeApp(options: const FirebaseOptions(
        apiKey: "AIzaSyD0PM5F-1BlxnIOZjWrveRKZTzOmv5PkO4",
        ...
        // IMPORTANT: Replace with real Web App ID from Firebase Console
        // Go to Firebase Console -> Project Settings -> Web Apps -> App ID
        appId: "1:1070521264518:web:PLACEHOLDER_REPLACE_WITH_REAL_ID"
    ));
  } else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyD0PM5F-1BlxnIOZjWrveRKZTzOmv5PkO4",
        appId: "1:1070521264518:android:f560e0157bd08d10f42407",
        messagingSenderId: "1070521264518",
        projectId: "foxgo-93552",
      ),
    );
