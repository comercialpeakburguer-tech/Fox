...
object FoxGoCallRouter {
    ...
    private fun buildOverlayPayload(data: Map<String, String>, notificationTitle: String? = null, notificationBody: String? = null): Map<String, Any?> {
        ...
        return mapOf(
            ...
            "driverEarningAmount" to (data["driver_earning_amount"] ?: data["earning"] ?: data["order_amount"] ?: ""),
            "distance" to data["distance"].orEmpty(),
            "distanceToPickupKm" to data["distance_to_pickup_km"].orEmpty(),
            "totalDistanceKm" to data["total_distance_km"].orEmpty(),
            "etaToPickupSeconds" to (data["eta_to_pickup_seconds"] ?: data["eta_seconds"] ?: ""),
            "expiresAt" to (data["expires_at"] ?: data["offer_expires_at"] ?: ""),
            "ttlSeconds" to (data["ttl_seconds"] ?: data["ttl"] ?: ""),
