...
class ItemController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $foxgoLogisticsErrors = \App\Services\FoxGo\ItemLogisticsProfileService::validationErrors($request, \Illuminate\Support\Facades\Config::get('module.current_module_type'));
...
$images = [];
        ...
        $item->save();
        \App\Services\FoxGo\ItemLogisticsProfileService::saveFromRequest($request, $item);
