...
class Order extends Model
{
    ...
    protected $casts = [
        ...
        'foxgo_bag_count' => 'integer',
        'foxgo_volume_count' => 'integer',
        'foxgo_logistics_weight_kg' => 'float',
        'foxgo_logistics_payload' => 'array',
        'foxgo_pickup_otp_verified_at' => 'datetime',
        'foxgo_pickup_otp_verified_by' => 'integer',
        'foxgo_pickup_otp' => 'string',
        'foxgo_pickup_otp_generated_at' => 'datetime',
